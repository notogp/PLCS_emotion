...
class SearchWidgetItem extends StatefulWidget {
  final String text;
  ...
  @override
  _SearchWidgetItemState createState() => _SearchWidgetItemState();
}

class _SearchWidgetItemState extends State<SearchWidgetItem> {
                      ...
                      actions: <Widget>[
                        ...
                        TextButton(
                          onPressed: () async {
                            ...
                            service.additem(
                                bikeid, cardid, category, description, context);
